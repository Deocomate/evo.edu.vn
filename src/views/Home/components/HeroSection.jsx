...
function HeroSection({
                         banner = {
                             title: 'Chào mừng đến với Evo Education',
                             description: 'Kiến tạo thế hệ trẻ sẵn sàng cho kỷ nguyên số.',
                             images: []
                         }
                     }) {
    ...
    return (<section className="relative w-full h-[70vh] sm:h-screen">
        <Carousel
        ...
        >
            <CarouselContent>
                {displayImages.map((src, index) => (<CarouselItem key={index}>
            ...
            <div className="max-w-4xl">
                ...
                <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Button asChild size="lg"
                            className="cursor-pointer bg-sky-500 hover:bg-sky-600 text-white font-bold text-lg w-full sm:w-auto transition-transform hover:scale-105">
                        <Link href="/training">
