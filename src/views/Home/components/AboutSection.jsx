...
function AboutSection() {
    return (<section className="bg-white py-24 sm:py-32">
        <div className="container mx-auto px-4">
                ...
                <div className="prose prose-lg max-w-none flex flex-col justify-center prose-p:font-medium">
                    <div className="text-center md:text-left">
                        ...
                        <p className="mt-4 leading-8 text-gray-600 text-justify">
                            Tại Evo Education, chúng tôi tự hào có đội ngũ giảng viên tâm huyết, sáng tạo, luôn sẵn
                            sàng tạo ra môi trường học tập thú vị. Evo không chỉ là nơi học, mà còn là một cộng
                            đồng, nơi các bạn trẻ có cơ hội giao lưu, trao đổi kiến thức và phát triển kỹ năng của
                            thế kỷ 21.
                        </p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
                ...
                <div
                    className="prose prose-lg max-w-none h-auto md:h-[500px] flex flex-col justify-center prose-p:font-medium prose-dd:font-medium">
                    <div className="text-center md:text-left">
                        ...
                        <p className="mt-6 leading-8 text-gray-600">
                            Chúng tôi mơ ước về một thế hệ trẻ Việt Nam làm chủ công nghệ, sẵn sàng cho kỷ nguyên số
                        ...
                        <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                            <div className="relative pl-9">
                                ...
                                <dd className="inline text-justify"> Trở thành hệ sinh thái giáo dục công nghệ hàng đầu
                                    tại Việt
                                    Nam, nơi trẻ em được trang bị những kỹ năng cần thiết để trở thành những nhà
                                    lãnh đạo công nghệ trong tương lai.
                                </dd>
                            </div>
                            <div className="relative pl-9">
                                <dt className="inline font-semibold text-gray-900">
                                ...
                                <dd className="inline text-justify"> Cung cấp các khóa học chất lượng cao, giúp trẻ em
                                    phát triển
                                    toàn diện các kỹ năng của thế kỷ 21 bao gồm tư duy logic, kỹ năng lập trình,
